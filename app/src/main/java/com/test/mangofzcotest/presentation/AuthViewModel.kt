...
import com.test.mangofzcotest.utils.ifNullOrBlank
...
class AuthViewModel @Inject constructor(
    ...
    fun checkAuthCode(phone: String, code: String) {
        viewModelScope.launch {
            _authScreenState.value = AuthScreenState.SmsCodeInput(phoneNumber = phone, isLoading = true)
            val result = checkAuthCodeUseCase(phone, code)
            _authScreenState.value = AuthScreenState.SmsCodeInput(phoneNumber = phone, isLoading = false)
    ...
    fun register(phone: String, name: String, username: String) {
        viewModelScope.launch {
            ...
            log("register: $result")
            _authScreenState.value = AuthScreenState.Register(phoneNumber = phone, isLoading = false)
